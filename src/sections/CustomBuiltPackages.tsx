...
export const CustomBuiltPackages = () => {
  // States
  ...
  return (
    <section className={`mt-10`}>
      ...
      <section className={`flex gap-4`}>
        <article
          className={`flex flex-col items-center w-40 bg-ravenci-light-gray opacity-60 hover:opacity-100 transition-all duration-500 ease-in-out`}
        >
